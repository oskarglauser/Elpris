...
import { SpotPriceChart } from '@/components/prototypes/prototype-c/SpotPriceChart';
...
export default function PrototypeCHome() {
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <BottomNav prototypePrefix="/prototype-c" />
    </div>
  );
}
