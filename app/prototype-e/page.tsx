...
import { SpotPriceChart } from '@/components/prototypes/prototype-e/SpotPriceChart';
...
export default function PrototypeEHome() {
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <BottomNav prototypePrefix="/prototype-e" />
    </div>
  );
}
